...
class MenuBar: UIView, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    lazy var collectionView: UICollectionView = {
        ...
        cv.backgroundColor = UIColor.rgb(red: 230, green: 23, blue: 31)
        cv.dataSource = self
        cv.delegate = self
        return cv
    }()
...
//        horizontalBarView.frame = CGRect(x: <#T##CGFloat#>, y: <#T##CGFloat#>, width: <#T##CGFloat#>, height: <#T##CGFloat#>)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.imageView.image = UIImage(named: imageNames[indexPath.row])?.withRenderingMode(UIImageRenderingMode.alwaysTemplate)
